package com.wenchen.yiyi.core.datastore.storage
 ...
 * 通用图片管理器：管理聊天图片和角色图片
 */
class ImageManager(private val context: Context = Application.Companion.instance) {
    ...
    fun saveChatImage(
        ...
        val fileExtension = if (format == Bitmap.CompressFormat.PNG) "png" else "jpg"
